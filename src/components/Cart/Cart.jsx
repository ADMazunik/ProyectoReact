...
const Cart = () => {
    ...
    const CartItem = ({ item }) => {
        return (
            <div className="cart-list cart-bg d-flex justify-content-between align-items-center py-2 px-3 gap-3">
                <img src={item.pictureURL} className={`card-img-top w-25 ${item.category}`} alt={item.title} />
                <div className="card-body text-light d-flex flex-column">
                    ...
                    <div className="card-text align-self-end d-flex flex-column">
